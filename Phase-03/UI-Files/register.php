...
if (isset($_POST['submitBtn'])) {
    ...
    $db = new DBConnect();
    $flag = $db->registerUser($firstName, $lastName, $don_id, $date, $dob, $gender, $bType, $address, $city, $mobile, $branch, $event);
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" action="register.php" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="form-label col-md-4">Don_id</label>
                        <div class="col-md-8">
                            <input type="text" required="true" class="form-control" name="don_id" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label col-md-4">Date</label>
                        <div class="col-md-8">
                            <input type="date" required="true" class="form-control" name="date" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="form-label col-md-4">branch</label>
                        <div class="col-md-8">
                            <input type="text" required="true" class="form-control" name="branch" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label col-md-4">Event</label>
                        <div class="col-md-8">
                            <input type="text" required="true" class="form-control" name="Event" >
                        </div>
                    </div>
                    <div class="form-group">
